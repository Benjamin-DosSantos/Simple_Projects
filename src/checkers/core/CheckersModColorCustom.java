...
public class CheckersModColorCustom extends Applet{
	...
	public void paint(Graphics g){
		...
		Color framebackground = new Color(68, 70, 72);
		Color checkerforground = new Color(4, 200, 0);
		Color checkerbackground = new Color(65, 140, 255);
		Color player1_color = new Color(12, 254, 17);
		Color player2_color = new Color(45, 117, 57);
		Color textcolor = new Color(190, 60, 65);
